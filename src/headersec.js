...
function Headersec(){
    return (
        ...
        <div className="flex space-x-4">
          <a
            href="www.shrirampur.com"
            className="italic font-medium text-[12px] sm:text-[15px] text-white bg-purple-500 rounded-lg px-3 py-1 hover:bg-purple-600"
          >
            Explore
          </a>
          <a
            href="https://www.google.com/maps/place/Shrirampur,+Maharashtra"
            className="italic font-bold text-[14px] sm:text-[18px] text-blue-500 hover:underline"
          >
            Shrirampur
          </a>
        </div>
